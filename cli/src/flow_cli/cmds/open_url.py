"""``flow open`` — open the SPA on the given resource (browser fallback)."""

from __future__ import annotations

import typer

from flow_cli.cmds._common import active_profile, client, resolve_id
from flow_cli.http import CLIError
from flow_cli.ui import info
...
def open_url(
    ...
    """Open the SPA on a Flow resource. Useful when a CLI surface is
