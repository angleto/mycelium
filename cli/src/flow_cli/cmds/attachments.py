"""``flow attachments`` — mint a scoped, multi-use download grant."""
...
from flow_cli.ui import emit_json, json_mode, success, warn
...
def download_capability(
    ...
    Hand these to an agent or machine WITHOUT Flow credentials: each curl
