"""``mycelium workspace`` — list workspaces the user belongs to.
...
``mycelium auth login --workspace <id> --profile <name>``. We surface that
...
from mycelium_cli.cmds._common import active_profile, client, get_json, short_id
