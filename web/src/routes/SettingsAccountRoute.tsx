...
// Settings → Account: everything that belongs to YOU and follows you
// into every workspace — sign-in security, your channels, how the app
// presents your day. Nothing here changes what a colleague sees.
    ...
    <>
      <section className="card">
        ...
        {status === null ? (
          ...
          <p>
            {t('app.title')}:{' '}
            <strong>{status.enabled ? t('mfa.enabled') : t('mfa.disabled')}</strong>
          </p>
        )}
