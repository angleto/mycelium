...
export const en = {
  ...
  paymentConnectors: {
    ...
    rotateSigningPrompt: 'New signing secret. For Stripe, paste the whsec_… from the dashboard; leave empty to have Mycelium mint one (native contract only). The current secret keeps verifying for the grace window:',
