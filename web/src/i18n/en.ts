...
export const en = {
  ...
  paymentConnectors: {
    ...
    amountsIncludeVat: 'Provider amounts already include VAT',
    amountsIncludeVatHint: 'How to read an amount that carries no tax breakdown. Getting this wrong makes every invoice systematically wrong, so it is a switch, never a guess.',
    ...
    assignPrompt: 'Client tag id to invoice for provider customer {{customer}}. Create the client in Clients first if it does not exist; it needs a VAT number or codice fiscale, a full address, and a codice destinatario or PEC.',
