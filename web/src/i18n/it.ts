...
export const it: Catalog = {
  ...
  advisory: {
    ...
    ctxHeading: 'Contesto richiesto',
    maxPriority: 'Priorità massima',
    maxPriorityHint: '1 = massima … 25',
    necessityFloor: 'Necessità minima',
    necessityAny: 'Qualsiasi',
    necMust: 'Indispensabile',
    necShould: 'Importante',
    necCould: 'Facoltativo',
    orHelp: 'I filtri si combinano in OR: un task corrisponde se soddisfa almeno un filtro attivo.',
