...
export const it: Catalog = {
  ...
  paymentConnectors: {
    ...
    rotateSigningPrompt: 'Nuova chiave di firma. Per Stripe incolla il whsec_… della dashboard; lascia vuoto per farla generare a Mycelium (solo contratto nativo). La chiave attuale continua a validare per la finestra di tolleranza:',
