...
export const it: Catalog = {
  ...
  paymentConnectors: {
    ...
    amountsIncludeVat: 'Gli importi del provider sono già IVA inclusa',
    amountsIncludeVatHint: 'Come leggere un importo che non porta con sé lo scorporo dell’imposta. Sbagliarlo rende sistematicamente sbagliata ogni fattura: per questo è un interruttore, non una stima.',
    series: 'Sezionale',
    ...
    assignPrompt: 'Id del tag cliente da fatturare per il cliente provider {{customer}}. Se non esiste crealo prima in Clienti: servono partita IVA o codice fiscale, indirizzo completo, e codice destinatario o PEC.',
