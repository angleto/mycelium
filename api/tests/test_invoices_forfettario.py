...
(IT01112223334_UQ6IZ.xml pre-send / _X3RtZ.xml signed): a forfettario
...
async def test_forfettario_draft_lines_causale_bollo_and_xml_preview() -> None:
    ...
    async with AsyncClient(transport=transport, base_url="http://t") as c:
        ...
        assert prof["default_iban"] == "IT60X0542811101000000123456"
        ...
        assert inv["payment_iban"] == "IT60X0542811101000000123456"
        ...
        assert prev["client"]["sdi_code"] == "WXYZ123"
        assert prev["client"]["pec"] is None
        assert prev["effective_iban"] == "IT60X0542811101000000123456"
