...
ROUTE_SCOPES: dict[tuple[str, str], object] = {
    ...
    # --- notifications ---
    ("GET", "/notifications"): "notifications:write",
    ("POST", "/notifications/dispatch"): "notifications:send",
    ("GET", "/notifications/prefs"): "notifications:write",
    ...
    ("GET", "/notifications/push/vapid-public-key"): "notifications:write",
    ...
    ("GET", "/tasks/{task_id}/reminders"): "notifications:write",
