...
ROUTE_SCOPES: dict[tuple[str, str], object] = {
    ...
    # Who passed each task on. Same read as the live possessions and
    # not a weaker one: it is the same rows, released.
    ("GET", "/tasks/leases/last-handoff"): "tasks:read",
    ...
    ("POST", "/tasks/{task_id}/leases/preempt"): "tasks:write",
    ...
    ("POST", "/workflows/import"): "workflows:write",
    ("POST", "/workflows/{workflow_id}/import"): "workflows:write",
    ("GET", "/workflows/{workflow_id}/export"): "workflows:read",
