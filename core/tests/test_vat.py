...
def test_strips_country_prefix_into_country() -> None:
    assert normalize_vat("IT13438810015", "IT") == ("IT", "13438810015")
    assert normalize_vat("it 13438810015", "IT") == ("IT", "13438810015")  # spaces + case
...
def test_bare_code_is_kept_with_given_country() -> None:
    assert normalize_vat("13438810015", "IT") == ("IT", "13438810015")
    assert normalize_vat(None, "IT") == ("IT", None)


def test_validation_requires_11_digits_for_italy() -> None:
    assert is_valid_vat_code("13438810015", "IT")
    assert not is_valid_vat_code("IT13438810015", "IT")  # prefix not stripped -> invalid
