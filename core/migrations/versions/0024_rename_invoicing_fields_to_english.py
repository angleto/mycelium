...
columns: a value like ``IT13438810015`` stored where IdPaese is already ``IT``
becomes ``13438810015`` (the bare IdCodice FatturaPA expects). The XML builder
...
def upgrade() -> None:
    ...
    # 'IT13438810015' with country_code 'IT' -> '13438810015'). Pure data
