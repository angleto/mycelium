...
A single ``Protocol`` covers the only Google endpoints Flow touches:
...
# OAuth scopes Flow requests. ``openid email`` to identify the Google
...
@dataclass(frozen=True)
class GoogleEvent:
    """The subset of a calendar.events resource Flow consumes."""
