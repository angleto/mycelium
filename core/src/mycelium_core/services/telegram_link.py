...
- **Webhook redemption + ingestion**: the bot HTTP webhook. Called
  ...
  Mycelium auth context). Looks up codes / chat ids via the SECURITY
...
async def create_link_code(
    ...
    *,
    ...
    from mycelium_core.telegram_client import telegram_deep_link
...
async def handle_webhook_update(payload: dict[str, object]) -> UpdateOutcome:
    ...
    from mycelium_core.services.notifications_telegram import sync_pref_from_link
