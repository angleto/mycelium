...
from mycelium_core.models.memory_blob import MemoryBlob, MemoryBlobTag
...
async def update_client(
    ...
    *,
    ...
    if "default_payment_conditions_code" in flds:
        from mycelium_core.services.payment_methods import validate_condizioni as _vc
    ...
    if "default_payment_method_code" in flds:
        from mycelium_core.services.payment_methods import validate_modalita as _vm
